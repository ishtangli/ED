...
$headerToFieldMap = [
    ...
    'Name_of_financially_responsible_body' => 'FINANCIAL_BODY_NAME',
...
$itemToFieldMap = [
    ...
    'Marks_and_numbers_pack_part1' => 'MARKS_PART1',
    ...
    'Amount_deducted_from_license' => 'AMOUNT_DEDUCTED',
    'Quantity_deducted_from_license' => 'QUANTITY_DEDUCTED',
...
if ($invoiceNumber !== '' && $source !== 'xml') {
    ...
    if (!$conn) {
        ...
        // Items
        $sqlItems = "SELECT * FROM " . $itemsTable . " WHERE " . $invoiceColumn . " = :ci";
